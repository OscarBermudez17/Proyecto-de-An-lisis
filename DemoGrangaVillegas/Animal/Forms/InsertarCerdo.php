                ...
                <div class="formulario">
                    ...
                    <form method="POST" action="../Data/registro.php">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ]{2,20}" placeholder="Nombre, Solo recibe letras" required/><br><br>
                        </div>  
    
                        <div>
                            <label for="raza">Raza</label><br>
                            <input type="text" name="raza" id="raza" pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ]{2,20}" placeholder="Raza, Solo recibe letras" required/><br><br>
                        </div>   
